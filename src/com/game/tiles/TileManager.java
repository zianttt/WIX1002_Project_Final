...
public class TileManager {
	...
	public TileManager(Game game, BufferedImageLoader loader, int choice) {
		...
		////
		scenes = loader.loadImage("/scenes.png");
		sss = new SpriteSheet(scenes);
		sceneDraw = loader.loadImage("/sceneDraw.png");
	...
	private void getTileImage() {
		...
		try {
			// 0 grass
			tiles[0] = new Tile();
			//tiles[0].image = ImageIO.read(getClass().getResourceAsStream("/grass00.png"));
			tiles[0].image = fss.grabImage(298, 232, 32, 32);
			
			
			// 1 water
			tiles[1] = new Tile();
			//tiles[1].image = ImageIO.read(getClass().getResourceAsStream("/water.png"));
